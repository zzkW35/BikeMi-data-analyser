...
def get_stations_full_info(get_stations_basic_info, stations_extra_info):
...
def find_station(stations, user_input):
...
def get_nearest_station(stations_full_info, lat, lon):
